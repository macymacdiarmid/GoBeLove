...
export default async function AdminDashboard() {
  ...
  const stats = [
    { label: "Products", value: productCount ?? 0, href: "/admin/products", bg: "#EF7B45", color: "#042A2B" },
    { label: "Orders",   value: orderCount   ?? 0, href: "/admin/orders",   bg: "#D84727", color: "#fff"    },
    { label: "Users",    value: userCount    ?? 0, href: "/admin/users",    bg: "#5EB1BF", color: "#042A2B" },
  ];
